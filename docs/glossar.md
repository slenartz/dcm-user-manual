...
### Datenkurator
Nutzer_in mit der Aufgabe, Jobs anzulegen, zu konfigurieren und auszuführen. Ist für die Kuratierung, die Validierung und Qualitätssicherung der Inhalte im Pre-Ingest verantwortlich.
...
### Objektvalidierung
Prüfung der im Payload enthaltenen Dateien (für unterstützte Formate) auf formale Korrektheit. Zur Validierung kommt der spezialisierte Dateiformat-Validator JHOVE zum Einsatz.
...
Paket, das an das Langzeitarchivsystem übergeben wird.
